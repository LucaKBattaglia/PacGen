...
public class GhostSpawner : MonoBehaviour
{
    ...
    private IEnumerator SpawnGhosts()
    {
        while (true)
        {
            ...
            if (activeGhosts.Count < maxGhosts && !isSpawning)
            {
                ...
                GhostAI ghostComponent = newGhost.GetComponent<GhostAI>();
                ...
                // Set up a listener to remove the ghost from the list when it is destroyed
                ghostComponent.OnGhostDestroyed += RemoveGhostFromList;
    ...
    private void RemoveGhostFromList(GameObject ghost)
    {
